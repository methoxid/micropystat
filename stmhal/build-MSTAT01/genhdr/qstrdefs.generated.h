...
QDEF(MP_QSTR_B12_NSS, (const byte*)"\xd5\xa5\x07" "B12_NSS")
...
QDEF(MP_QSTR_C6_PWM, (const byte*)"\xc5\x0f\x06" "C6_PWM")
...
QDEF(MP_QSTR_CS_I2C, (const byte*)"\xf2\xe5\x06" "CS_I2C")
...
QDEF(MP_QSTR_MX10, (const byte*)"\x91\xd8\x04" "MX10")
QDEF(MP_QSTR_MX11, (const byte*)"\x90\xd8\x04" "MX11")
QDEF(MP_QSTR_MX20, (const byte*)"\xf2\xd8\x04" "MX20")
QDEF(MP_QSTR_MX21, (const byte*)"\xf3\xd8\x04" "MX21")
QDEF(MP_QSTR_MX30, (const byte*)"\xd3\xd8\x04" "MX30")
QDEF(MP_QSTR_MX31, (const byte*)"\xd2\xd8\x04" "MX31")
...
QDEF(MP_QSTR_U3RX, (const byte*)"\xc9\x7a\x04" "U3RX")
